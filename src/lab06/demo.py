# demo.py
"""
Демонстрация работы ЛР-6: Generics и typing.
Сценарии:
1. Аннотации типов и Generic-коллекция (оценка 3)
2. Методы find, filter, map с разными типами (оценка 4)
3. Протоколы и структурная типизация (оценка 5)
"""
